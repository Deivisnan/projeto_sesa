-- CreateEnum
CREATE TYPE "TipoUnidade" AS ENUM ('TI', 'CAF', 'UBS', 'UPA', 'HOSPITAL');

-- CreateEnum
CREATE TYPE "StatusCompra" AS ENUM ('PENDENTE', 'RECEBIDA_PARCIALMENTE', 'CONCLUIDA', 'CANCELADA');

-- CreateEnum
CREATE TYPE "StatusSolicitacao" AS ENUM ('AGUARDANDO_ANALISE', 'APROVADA', 'EM_SEPARACAO', 'DESPACHADA', 'ATENDIDA_PARCIAL', 'ATENDIDA_INTEGRAL', 'RECUSADA');
...
-- CreateTable
CREATE TABLE "medicamentos_grupos" (
    "id" UUID NOT NULL,
    "nome" VARCHAR(255) NOT NULL,
    "estoque_minimo" INTEGER NOT NULL DEFAULT 0,

    CONSTRAINT "medicamentos_grupos_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "unidades_medicamentos_permitidos" (
    "id" UUID NOT NULL,
    "id_unidade" UUID NOT NULL,
    "id_medicamento" UUID NOT NULL,
    "autorizado_em" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "unidades_medicamentos_permitidos_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "medicamentos_grupos_nome_key" ON "medicamentos_grupos"("nome");

-- CreateIndex
CREATE UNIQUE INDEX "medicamentos_codigo_br_key" ON "medicamentos"("codigo_br");

-- CreateIndex
CREATE UNIQUE INDEX "medicamentos_id_grupo_apresentacao_key" ON "medicamentos"("id_grupo", "apresentacao");

-- CreateIndex
CREATE UNIQUE INDEX "unidades_medicamentos_permitidos_id_unidade_id_medicamento_key" ON "unidades_medicamentos_permitidos"("id_unidade", "id_medicamento");
...
-- CreateIndex
CREATE INDEX "auditorias_entidade_id_entidade_idx" ON "auditorias"("entidade", "id_entidade");
...
-- AddForeignKey
ALTER TABLE "medicamentos" ADD CONSTRAINT "medicamentos_id_grupo_fkey" FOREIGN KEY ("id_grupo") REFERENCES "medicamentos_grupos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "unidades_medicamentos_permitidos" ADD CONSTRAINT "unidades_medicamentos_permitidos_id_unidade_fkey" FOREIGN KEY ("id_unidade") REFERENCES "unidades"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "unidades_medicamentos_permitidos" ADD CONSTRAINT "unidades_medicamentos_permitidos_id_medicamento_fkey" FOREIGN KEY ("id_medicamento") REFERENCES "medicamentos"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "auditorias" ADD CONSTRAINT "auditorias_id_usuario_fkey" FOREIGN KEY ("id_usuario") REFERENCES "usuarios"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
